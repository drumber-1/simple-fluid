...
void project_hodge_decomp(FluidArray<NX, NY>& xvel, FluidArray<NX, NY>& yvel, FluidArray<NX, NY>& p, FluidArray<NX, NY>& div, float dx, float dy, size_t nsteps, BoundaryFunction<NX, NY> boundary) {
